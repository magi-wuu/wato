...
def generate_launch_description():
    ...
    costmap_node = Node(
        ...
        parameters=[sim_time, LaunchConfiguration('costmap_param_file')],
    )
    ...
    map_memory_node = Node(
        ...
        parameters=[sim_time, LaunchConfiguration('map_memory_param_file')],
    )
    ...
    planner_node = Node(
        ...
        parameters=[sim_time, LaunchConfiguration('planner_param_file')],
    )
    ...
    control_node = Node(
        ...
        parameters=[sim_time, LaunchConfiguration('control_param_file')],
    )
